...
const page = usePage()
const role = page.props.role as { name: string; permissions: Array<{ id: number; name: string }> };
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        <div class="flex h-full flex-1 flex-col gap-4 rounded-xl p-4 overflow-x-auto">
            <div class="flex flex-col space-y-6 min-h-full">
                <HeadingSmall title="Edit role" description="Update the role name and manage its assigned permissions" />
